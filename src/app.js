...
require("./seguridad-espe-tesis/sockets/socket");
require("./seguridad-espe-vinculacion/sockets/socket");
...
import TecnicoRoute from './MIES_APP/routes/tecnico';
import AdultoMayorRoute from './MIES_APP/routes/adultoMayor';
import SupervisorRoute from './MIES_APP/routes/supervisor';
import LawtonRoute from './MIES_APP/routes/escalaLawtonBrody';
import YesavageRoute from './MIES_APP/routes/escalaYesavage';
import MiniMentalRoute from './MIES_APP/routes/mini_mental';
import BarthelRoute from './MIES_APP/routes/indiceBarthel';
import EncabezadoRoute from './MIES_APP/routes/encabezado';
import ReportesRoute from './MIES_APP/routes/reportes';
...
//encuestas 
import Encuesta1Router from './encuestas/routes/encuesta1.routes';
import Encuesta2Router from'./encuestas/routes/encuesta2.routes'
import EncuestadorRouter from'./encuestas/routes/encuestador.routes';
...
import LoginGecRoute from'./GecSurvey_srv/srv/routes/login.routes';
import UsuarioGecRoute from'./GecSurvey_srv/srv/routes/usuario.routes';
import EncuestaGecRoute from'./GecSurvey_srv/srv/routes/encuesta.routes';
import GraficaGecRoute from './GecSurvey_srv/srv/routes/grafica.routes';
...
import AUTH  from "./seguridad-espe-tesis/routes/auth";
import  USUARIOS from "./seguridad-espe-tesis/routes/usuarios";
import MENSAJES from "./seguridad-espe-tesis/routes/mensajes";
import SALAS from "./seguridad-espe-tesis/routes/salas";
import PBLIC from "./seguridad-espe-tesis/routes/publicaciones";
import  COM from "./seguridad-espe-tesis/routes/comentarios";
import UPLS from "./seguridad-espe-tesis/routes/uploads";
import BUSCAR from "./seguridad-espe-tesis/routes/buscar";
import UBICAIONALL from "./seguridad-espe-tesis/routes/ubicaciones";
import REPORTM from "./seguridad-espe-tesis/routes/reportes";
import NOTIFICACION from "./seguridad-espe-tesis/routes/notificaciones";
import DENUNCIAS from "./seguridad-espe-tesis/routes/denuncias";
import EMAILESPES  from "./seguridad-espe-tesis/routes/email";
import DOCUMENTOS  from "./seguridad-espe-tesis/routes/documents";
...
import AUTH_v2  from "./seguridad-espe-vinculacion/routes/auth";
import  USUARIOS_v2 from "./seguridad-espe-vinculacion/routes/usuarios";
import MENSAJES_v2 from "./seguridad-espe-vinculacion/routes/mensajes";
import SALAS_v2 from "./seguridad-espe-vinculacion/routes/salas";
import PBLIC_v2 from "./seguridad-espe-vinculacion/routes/publicaciones";
import  COM_v2 from "./seguridad-espe-vinculacion/routes/comentarios";
import UPLS_v2 from "./seguridad-espe-vinculacion/routes/uploads";
import BUSCAR_v2 from "./seguridad-espe-vinculacion/routes/buscar";
import UBICAIONALL_v2 from "./seguridad-espe-vinculacion/routes/ubicaciones";
import REPORTM_v2 from "./seguridad-espe-vinculacion/routes/reportes";
import NOTIFICACION_v2 from "./seguridad-espe-vinculacion/routes/notificaciones";
import DENUNCIAS_v2 from "./seguridad-espe-vinculacion/routes/denuncias";
import EMAILESPES_v2  from "./seguridad-espe-vinculacion/routes/email";
import DOCUMENTOS_v2  from "./seguridad-espe-vinculacion/routes/documents";
import INSTITUCION_v2  from "./seguridad-espe-vinculacion/routes/instituciones";
