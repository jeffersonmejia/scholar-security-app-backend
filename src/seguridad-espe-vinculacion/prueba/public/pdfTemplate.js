module.exports = (dataInfo) => {
  ...
  data.forEach((item) => {
    ...
    if (!unidadEducativa) {
      // Si unidadEducativa aún no tiene valor, asigna el primer elemento
     ...
     <body>
       <div class="cont-info">
         ...
         <div>
           ...
           <h1 class="text-title">SEDE SANTO DOMINGO DE LOS TSÁCHILAS</h1>
           <h1 class="text-title">REPORTE DE INCIDENTES EN UNIDADES EDUCATIVAS</h1>
         </div>
         <div>
           <img
             src="https://res.cloudinary.com/dfitq38dk/image/upload/v1698083390/LogoVertical_F2.png"
           />
         </div>
       </div>
           ...
           <tr class="top">
             <td colspan="14">
               ...
               <div class="cont-aling">
                 <div class="text-title">Reporte de Emergencias de Unidad Educativa ${unidadEducativa}</div>
